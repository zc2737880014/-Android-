...
public class MainActivity extends AppCompatActivity {
    ...
    private void postVideo() {
        ...
        miniDouyinService = initMiniDouyinService();
        miniDouyinService.postVideos(student_id,user_name,coverImagePart,videoPart).enqueue(new Callback<PostVideoResponse>() {
            @Override
            public void onResponse(Call<PostVideoResponse> call, Response<PostVideoResponse> response) {
                if (response != null && response.isSuccessful() && response.body() != null && response.body().isSuccess()) {
                    mBtn.setText("Post Succeed!");
                    mBtn.setEnabled(true);
                } else {
                    mBtn.setText("Post Failed!");
                    mBtn.setEnabled(true);
                }
            }
            @Override
