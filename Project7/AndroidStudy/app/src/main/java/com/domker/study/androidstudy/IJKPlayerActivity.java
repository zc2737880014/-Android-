...
public class IJKPlayerActivity extends Activity implements View.OnClickListener {
    ...
    private void init() {
        ...
        volume_bar = findViewById(R.id.seekBar_volume);
        ...
        volume_bar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            @Override
            public void onStopTrackingTouch(SeekBar seekBar) {
                ijkPlayer.mMediaPlayer.setVolume((float)(1.0f)*volume_bar.getProgress()/100,(float)(1.0f)*volume_bar.getProgress()/100);
                handler.sendEmptyMessageDelayed(MSG_REFRESH, 100);
            }
        });
