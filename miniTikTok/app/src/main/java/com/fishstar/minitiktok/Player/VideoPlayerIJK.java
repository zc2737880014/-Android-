package com.fishstar.minitiktok.Player;
...
public class VideoPlayerIJK extends FrameLayout {
    ...
    private float vol_left=0.0f,vol_right=0.0f;

    public float getVol_left(){
        return vol_left;
    }
    ...
    public void addVoice(){
        if(mMediaPlayer!=null&&vol_left<1&&vol_right<1){
            vol_left+=0.1f;
            vol_right+=0.1f;
            mMediaPlayer.setVolume(vol_left,vol_right);
        }
    }
    public void subVoice(){
        if(mMediaPlayer!=null&&vol_left>0&&vol_right>0){
            vol_left-=0.1f;
            vol_right-=0.1f;
            mMediaPlayer.setVolume(vol_left,vol_right);
        }
    }
    public void setVoice(float v){
        if(mMediaPlayer!=null){
            vol_left=v;
            vol_right=v;
